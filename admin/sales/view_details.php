    ...
    <div class="card card-outline card-navy rounded-0 shadow">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="./?page=sales" class="btn btn-primary border btn-sm"><i class="fa fa-angle-left"></i> Back to List</a>
            </div>
        </div>
        <div class="card-body">
            <div class="container-fluid row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12"  id="printout">
                    ...
                    <h3 class="d-flex border-top border-dark">
                        ...
                        <div class="col-7 text-right"><?= isset($amount) ? format_num($amount) : 0 ?></div>
                    </h3>
					<?php
						//$vat = $amount * 0.10715;
						//$vatable = $amount - $vat;
					...
					?>
					 <h5 class="d-flex">
                        <div class="col-5">Vatable</div>
                        <div class="col-7 text-right"><?= isset($vatable) ?  number_format($vatable, 2, '.', ',') : 0 ?></div>
                    </h5>
					 <h5 class="d-flex">
                        <div class="col-5">VAT</div>
                        <div class="col-7 text-right"><?= isset($vat) ? number_format($vat, 2, '.', ',') : 0 ?></div>
                    </h5>
            ...
            <div class="row justify-content-center">
				<?php
					$receiptDate = date("Y-m-d h:i A", strtotime($date_created));
					$currentdate = date('Y-m-d h:i A', time());
					$secs = strtotime($currentdate) - strtotime($receiptDate);// == <seconds between the two times>
					$days = $secs / 86400;
					...
					{
						if($days == 0)
							echo '<a class="btn btn-primary bg-gradient-primary border col-lg-3 col-md-4 col-sm-12 col-xs-12 rounded-pill" href="./?page=sales/manage_sale&id='.$x.'"><i class="fa fa-edit"></i> Edit</a>';
					}
					else
					{
						echo '<a class="btn btn-primary bg-gradient-primary border col-lg-3 col-md-4 col-sm-12 col-xs-12 rounded-pill" href="./?page=sales/manage_sale&id='.$x.'"><i class="fa fa-edit"></i> Edit</a>';
