          ...
          <nav class="mt-4">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
              ...
              if ($_settings->userdata('type') == 1) {
                ...
                echo '<a href="' . base_url . 'admin/?page=reports" class="nav-link nav-reports">';
                ...
                echo '</li>';
                echo '<li class="nav-item dropdown">';
                echo '<a href="' . base_url . 'admin/?page=reports/weekly" class="nav-link nav-reportsWeekly">';
                echo '<i class="nav-icon fas fa-calendar-day"></i>';
                echo '<p>';
                ...
                echo '</li>';
                echo '<li class="nav-item dropdown">';
                echo '<a href="' . base_url . 'admin/?page=reports/monthly" class="nav-link nav-reportsMonthly">';
                echo '<i class="nav-icon fas fa-calendar-day"></i>';
                echo '<p>';
...
<script>
  $(document).ready(function() {
    ...
    if (page == "reports_weekly") {
      $('aside.main-sidebar .nav-link.nav-reportsWeekly').addClass('active')
    }
    if (page == "reports_monthly") {
      $('aside.main-sidebar .nav-link.nav-reportsMonthly').addClass('active')
    }
