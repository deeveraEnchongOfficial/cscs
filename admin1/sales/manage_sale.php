                        ...
                        <div class="border rounded-0 shadow bg-gradient-navy px-1 py-1" id="sales-panel">
                            <div class="d-flex h-100 w-100">
                                ...
                                <div class="col-5 h-100">
                                    ...
                                    <h4 class="text-light w-100 d-flex">
                                    ...
                                    <h4 class="d-flex w-100 align-items-center">
                                        <div class="col-4" style="font-size: 23px">Tendered:</div>
                                        <div class="col-8">
                                            <input type="text" pattern="[0-9\.]*$" style="height: 35px" class="form-control form-control-lg rounded-0 text-right" id="tendered" name="tendered" value="<?= isset($tendered) ? str_replace(",", "", format_num($tendered)) : '0' ?>" required />
                                        </div>
                                    </h4>
                                    <h4 class="d-flex w-100 align-items-center">
                                        <div class="col-4" style="font-size: 23px">Change:</div>
                                        <div class="col-8">
                                            <input type="text" pattern="[0-9\.]*$" style="height: 35px" class="form-control form-control-lg rounded-0 text-right" id="change" value="<?= isset($amount) && isset($tendered) ? format_num($tendered - $amount) : '0' ?>" readonly />
                                        </div>
                                    </h4>
                                    <h4 class="d-flex w-100 align-items-center">
                                        <div class="col-4" style="font-size: 23px">Type:</div>
                                        <div class="col-8">
